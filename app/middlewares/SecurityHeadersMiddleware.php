...
class SecurityHeadersMiddleware
{
	...
	public function before(array $params): void
	{
		...
		$csp = "default-src 'self'; script-src 'self' 'nonce-{$nonce}' 'unsafe-inline' https://cdn.jsdelivr.net; style-src 'self' {$tracyCssBypass} 'unsafe-inline' https://cdn.jsdelivr.net; font-src 'self' https://cdn.jsdelivr.net data:; img-src 'self' data:;";
